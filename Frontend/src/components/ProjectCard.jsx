const ProjectCard = ({ project }) => {
  ...
  return (
    <div className="bg-white w-1/3  dark:bg-[#121212] border border-zinc-200 dark:border-[#262626] hover:border-zinc-300 dark:hover:border-[#404040] rounded-2xl p-8 flex flex-col hover:-translate-y-1 hover:shadow-2xl transition-all duration-200">
